...
;// CONCATENATED MODULE: ./src/Components/drudge.tsx
...
const { parse } = __webpack_require__(3264);
const Drudge = () => {
    ...
    return ((0,jsx_runtime.jsx)(jsx_runtime.Fragment, { children: (0,jsx_runtime.jsx)("h2", { children: storeTitles.map((title, id) => {
                return ((0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [(0,jsx_runtime.jsx)("a", Object.assign({ href: storeLinks[id], target: "_blank" }, { children: storeTitles[id] })), (0,jsx_runtime.jsx)("br", {}), (0,jsx_runtime.jsx)("br", {})] }));
            }) }) }));
};
/* harmony default export */ const drudge = (Drudge);

;// CONCATENATED MODULE: ./src/Components/tass.tsx
var tass_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
const TASS = () => {
    ...
    const [storeLinks, setStoreLinks] = react.useState([]);
    react.useEffect(() => {
        (() => tass_awaiter(void 0, void 0, void 0, function* () {
            const rss = yield tass_parse(tassFeed);
            console.log(rss);
            const tempTitles = [];
            const tempStoreLinks = [];
...
/* harmony default export */ const tass = (TASS);
...
const App = () => {
    return ((0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [(0,jsx_runtime.jsx)(drudge, {}), (0,jsx_runtime.jsx)("h1", { children: "HEHEHEEH" }), (0,jsx_runtime.jsx)("br", {}), (0,jsx_runtime.jsx)(tass, {})] }));
};
